    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL, verbose_name='Instance created by')),
            ],
        ),
        migrations.CreateModel(
            name='Hall',
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Instance updated at')),
                ('is_active', models.BooleanField(default=True, verbose_name='In run?')),
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='halls', to=settings.AUTH_USER_MODEL, verbose_name='Instance created by')),
            ],
        ),
        migrations.CreateModel(
            name='Ticket',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('starts', models.DateField(default=datetime.date(2020, 6, 13), verbose_name='starts')),
                ('ends', models.DateField(default=datetime.date(2020, 6, 28), verbose_name='ends')),
                ('time_starts', models.TimeField(verbose_name='starts at: ')),
                ('time_ends', models.TimeField(verbose_name='ends at: ')),
